...
$(document).ready(function() {
	$('#choose_card_1').bind('click', function(event) {
		delayLoad('#frame_turn', 1000, 'html/大小姐.html');
		event.preventDefault();
    });
	
	$('#choose_card_2').bind('click', function(event) {
		delayLoad('#frame_turn', 1000, 'html/二小姐.html');
		event.preventDefault();
    });
	
	$('#choose_card_3').bind('click', function(event) {
		delayLoad('#frame_turn', 1000, 'html/魔理沙.html');
		event.preventDefault();
    });
	
	$('#choose_card_4').bind('click', function(event) {
		delayLoad('#frame_turn', 1000, 'html/灵梦.html');
		event.preventDefault();
    });
	
	$('#choose_card_5').bind('click', function(event) {
		delayLoad('#frame_turn', 1000, 'html/早苗.html');
		event.preventDefault();
    });
	
	$('#choose_card_6').bind('click', function(event) {
		delayLoad('#frame_turn', 1000, 'html/爱丽丝.html');
		event.preventDefault();
    });
	
	$('#choose_card_7').bind('click', function(event) {
		delayLoad('#frame_turn', 1000, 'html/古明地恋.html');
		event.preventDefault();
    });
	
	$('#icon_home').bind('click', function(event) {
		delayLoad('#frame_turn', 500, 'html/home.html');
		event.preventDefault();
    });
});
